...
Identity.prototype.Schema =
	...
	"</element>" +
	"<optional>"+
		"<element name='SpawnUnitsAfterConstruction'>"+
			"<attribute name='datatype'>" +
				"<value>tokens</value>" +
			"</attribute>" +
			"<text/>" +
...
Identity.prototype.GetSpawnUnitList = function()
{
	if (this.template.SpawnUnitsAfterConstruction && this.template.SpawnUnitsAfterConstruction._string)
		return this.template.SpawnUnitsAfterConstruction._string.split(/\s+/);
	return [];
};
