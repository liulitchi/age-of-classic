...
Attack.prototype.PerformAttack = function(type, target)
{
	...
	else if (type == "Capture")
	{
		...
		let multiplier = GetDamageBonus(target, this.GetBonusTemplate(type), type, this.entity);
	...
	else
	{
		...
		cmpDamage.CauseDamage({
			...
			"target": target,
			"attacker": this.entity,
			"multiplier": GetDamageBonus(target, this.GetBonusTemplate(type), type, this.entity),
			"type": type,
			"attackerOwner": attackerOwner
		});
	}
